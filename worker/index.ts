...
const REFRESH_DISPATCH_URL = `https://api.github.com/repos/techmuns/mganews/actions/workflows/${REFRESH_WORKFLOW}/dispatches`;
...
async function handleSubscribe(request: Request, env: Env): Promise<Response> {
  ...
  let feeds = Array.isArray(body.feeds)
    ...
    : [];
  if (!feeds.length) feeds = ['watchlist'];
