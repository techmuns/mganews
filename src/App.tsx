...
import type { Company, FeedKey } from './lib/types';
...
// This edition has a single Watchlist feed (no Portfolio / Universe): the
// companies in public/data/companies.json plus anything added via "+ Add".
const FEED: FeedKey = 'watchlist';
...
export default function App() {
  ...
  const feedItems = useMemo(
    () => visibleItems.filter((i) => i.scope.includes(FEED)),
    [visibleItems],
  );
      ...
      <main className="mx-auto max-w-7xl px-4 py-5 sm:px-6">
        ...
        <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
          ...
          <p className="text-xs font-medium text-slate-500">
            <span className="font-bold text-slate-700">Watchlist</span>
            <span className="mx-1.5 text-slate-300">·</span>
            The companies you&apos;re tracking
          </p>
        </div>
